      ...
      <section className="catalog">
        ...
        <div className="catalog__films-list">
          ...
          <article className="small-film-card catalog__films-card">
            <div className="small-film-card__image">
              <img
                src="markup/img/bohemian-rhapsody.jpg"
          ...
          <article className="small-film-card catalog__films-card">
            <div className="small-film-card__image">
              <img
                src="markup/img/we-need-to-talk-about-kevin.jpg"
          ...
          <article className="small-film-card catalog__films-card">
            <div className="small-film-card__image">
              <img
                src="markup/img/what-we-do-in-the-shadows.jpg"
          ...
          <article className="small-film-card catalog__films-card">
            <div className="small-film-card__image">
              <img
                src="markup/img/johnny-english.jpg"
                alt="Johnny English"
                width={280}
                height={175}
              />
          ...
          <article className="small-film-card catalog__films-card">
            <div className="small-film-card__image">
              <img
                src="markup/img/shutter-island.jpg"
                alt="Shutter Island"
                width={280}
                height={175}
              />
